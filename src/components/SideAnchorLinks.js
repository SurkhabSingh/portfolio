...
const SideAnchorLinks = () => {
  ...
  return (
    <>
      <StyledLeftAnchor>
        <StyledAnchorLink
          href="https://www.linkedin.com/in/surkhab-singh-0ba6a3258/"
          target="_blank"
          aria-label="LinkedIn"
        >
          <svg
        ...
        <StyledAnchorLink
          href="https://github.com/SurkhabSingh"
          target="_blank"
          aria-label="Github"
        >
          <svg
        ...
        <StyledAnchorLink
          href="mailto:surkhab26singh@gmail.com"
      ...
      <StyledRightAnchor></StyledRightAnchor>
    </>
  );
};
